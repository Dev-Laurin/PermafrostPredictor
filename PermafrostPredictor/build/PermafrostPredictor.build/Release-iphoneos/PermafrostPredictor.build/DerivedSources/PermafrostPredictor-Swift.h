...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified aairTextField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified tairTextField;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified meanGroundSurfaceTemp;
...
- (IBAction)infoButtonPressed:(UIBarButtonItem * _Nonnull)sender;
